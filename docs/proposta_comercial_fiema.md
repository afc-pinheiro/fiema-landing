...
* **Propriedade Intelectual**: Após a quitação da última parcela do projeto, toda a propriedade intelectual, códigos-fonte (frontend, CMS e ferramentas de migração), repositórios Git e credenciais administrativas serão transferidos de forma **integral e vitalícia para a FIEMA**.
